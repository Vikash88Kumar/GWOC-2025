...
import { login, logout } from "../../contextapi/authSlice.js";
...
const Dashboard: React.FC = () => {
  ...
  // --- FIXED: Moved all useMemo hooks BEFORE the conditional return ---
  ...
  // Standard variables (not hooks) can stay after the check
              ...
              {recentClients.map((client) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <Badge className={["rounded-full px-3 py-1 border", statusColors[client.status]].join(" ")}>
              ...
              {recentTestimonials.map((testimonial) => (
                ...
                >
                  <div className="flex items-start justify-between gap-3 mb-2">
                    ...
                    <Badge className={["rounded-full px-3 py-1 border", statusColors[testimonial.status]].join(" ")}>
                      {testimonial.status}
                    </Badge>
                  </div>
